...
func GenerateFunctionWrappers(filesystem FileSystem, opts GenerateOptions) (string, error) {
	...
	for _, entry := range entries {
		...
		if strings.HasPrefix(name, "generated_targs_") {
			continue
		}
	...
	buf.WriteString("// Code generated by targs. DO NOT EDIT.\n\n")
	...
	filename := filepath.Join(dir, fmt.Sprintf("generated_targs_%s.go", packageName))
